...
<%@ Import Namespace="BlackTech.API.Entity.SnippetEntity" %>
...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //加载QMQ分类
            qmqList = SnippetDBHelper.GetAllList("C#").DistinctBy(x => x.CataType).ToList();
    ...
    protected void TestCaseRefresh(object sender, StoreReadDataEventArgs e)
    {
        ...
        {
            txtLogs.Text = "";
            List<SnippetEntity> selectCaseList = SnippetDBHelper.GetAllList("C#").Where(x => x.CataType == this.cmbSnippet.SelectedItem.Text).ToList(); ;
    ...
    protected void LoadRequest(object sender, DirectEventArgs e)
    {
        try
        {
            ...
            List<SnippetEntity> selectCaseList = SnippetDBHelper.GetAllList("C#").Where(x => x.CataType == this.cmbSnippet.SelectedItem.Text
    ...
    {
        this.editWin.Show();
        SnippetEntity SnippetEntity = SnippetDBHelper.GetSnippetByID("C#", this.cmbSnippet.SelectedItem.Text, this.cmbTestCase.SelectedItem.Text);
